...
CREATE TABLE communities.communities (
    ...
    community_type VARCHAR(50) NOT NULL DEFAULT 'mutual_aid',  -- Sprint 47: Group Communities — 'mutual_aid' | 'group'
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT chk_community_type CHECK (community_type IN ('mutual_aid', 'group'))
);
...
-- Sprint 47: Group Communities — activities + participants

# Sprint 128 PR C — Standing preview parity — SHIPPED v11.50.0

**Shipped**: 2026-09-11 · **Squash**: `55a536fc` · **PR**: [#233](https://github.com/ravichavali/karmyq/pull/233)
**Outcome**: MERGED and DEPLOYED. CI/CD run [34643147235](https://github.com/ravichavali/karmyq/actions/runs/34643147235) — 14/14 jobs success including `Deploy to Demo`, none skipped. Smoke-tested live 2026-09-11: landing `200`; `POST /api/auth/login` and `GET /api/requests/feed` both `401` in the ADR-074 error shape rather than `502`, so every service is up.
...
## Merge was blocked, then resolved by the maintainer — 2026-09-11 (historical)
...
**Resolved**: the maintainer merged #233 in the GitHub UI, which is option 2 below. The deploy fired automatically on the master push and was verified by job and by live smoke test.

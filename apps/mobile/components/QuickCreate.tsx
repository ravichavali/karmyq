  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await api.createRequest({
        ...
        community_id:
          postingMode === "specific" ? selectedCommunity : undefined,
      });
    ...
    <View style={styles.container}>
      ...
      <View style={styles.postingOptions}>
        ...
        >
          <Ionicons
            name={
              postingMode === "all" ? "radio-button-on" : "radio-button-off"
            }
            size={20}
          ...
          <Text
            style={[
              styles.radioLabel,
              postingMode === "all" && styles.radioLabelActive,
            ]}
          >
        ...
        >
          ...
          <Text
            style={[
              styles.radioLabel,
              postingMode === "specific" && styles.radioLabelActive,
            ]}
          >
      ...
      <Text style={styles.helpText}>{description.length}/500 characters</Text>
    </View>
  );
}

              ...
              <div className="flex items-center gap-4 mb-4">
                <button
                  ...
                  className={`px-3 py-1.5 rounded-md text-sm font-medium ${
                    memberFilter === 'active' ? 'bg-primary-light text-primary' : 'text-text-muted hover:bg-surface-raised'
                  }`}
                >
                ...
                <button
                  ...
                  className={`relative px-3 py-1.5 rounded-md text-sm font-medium ${
                    memberFilter === 'pending' ? 'bg-primary-light text-primary' : 'text-text-muted hover:bg-surface-raised'
                  }`}
                >

  ...
  return (
    <div className="space-y-3">
      ...
      <div className="space-y-2">
        {members.map(member => (
          <div key={member.provider_id} className="flex items-center justify-between bg-surface-raised rounded-lg border border-border px-3 py-2">
            <div className="flex items-center gap-2 min-w-0">
              <div className="w-7 h-7 bg-gradient-to-br from-karmyq-green-500 to-karmyq-teal-600 rounded-full flex items-center justify-center text-white text-xs font-semibold flex-shrink-0">
            ...
            <div className="flex items-center gap-2">
              ...
              {isCollectiveAdmin && member.provider_id !== undefined && (
                <button

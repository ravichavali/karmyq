...
const BelongingSection = dynamic(() => import('@/components/BelongingSection'), {
    ...
    <>
      ...
      <Layout>
        <div className="kq-page py-8">
          ...
          {success && (
            <div className="bg-success-light border border-karmyq-green-400 text-success px-4 py-3 rounded mb-4">
              {success}
            </div>
          )}
          ...
          <div className="kq-card mb-6">
            ...
            {editing ? (
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={email}
                      disabled
                      className="w-full px-3 py-2 border border-border rounded bg-border-light cursor-not-allowed"
                    />
              ...
              <div className="space-y-3">
                <div>
                  <label className="text-sm font-medium text-text-subtle">Name</label>
                  <p className="text-text">{user.name}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-text-subtle">Email</label>
          ...
          <div className="kq-card mb-6">
            ...
            {showKarmaToMe ? (
              loadingKarma ? (
                <div className="text-center py-8 text-text-subtle">Loading karma data...</div>
              ) : karmaData ? (
                <>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="bg-success-light rounded-lg p-4 text-center">
                      <p className="text-3xl font-bold text-success">{karmaData.recent_helps || 0}</p>
                      <p className="text-sm text-text-muted mt-1">Recent Helps</p>
                      <p className="text-xs text-text-subtle mt-1">Last 30 days</p>
                    </div>
                    <div className="bg-accent-light rounded-lg p-4 text-center">
                      <p className="text-3xl font-bold text-accent">{karmaData.recent_requests || 0}</p>
                      <p className="text-sm text-text-muted mt-1">Recent Requests</p>
                      <p className="text-xs text-text-subtle mt-1">Last 30 days</p>
                    </div>
                  ...
                  <div className="mt-4 p-4 bg-primary-light border border-primary-medium rounded-lg">
                ...
                <div className="text-center py-8">
                  <p className="text-text-muted mb-2">No karma data available yet</p>
                  <p className="text-sm text-text-subtle">Start helping others in your communities to earn karma!</p>
                </div>
              )
            ) : (
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {communities.map((community) => (
                  <Link
                    ...
                    className="border border-border rounded-lg p-4 hover:border-primary-medium hover:bg-primary-light transition-colors"
                  >
                    <h3 className="font-semibold text-text mb-2">{community.name}</h3>
                    <p className="text-sm text-text-muted line-clamp-2 mb-3">{community.description}</p>
          ...
          <div className="mb-6">
            ...
            <div className="mt-4 flex items-start gap-2 bg-primary-light border border-primary-medium rounded-lg p-4">
              <svg className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <div className="text-sm">
                <p className="font-medium text-primary-dark mb-1">Want to invite others?</p>

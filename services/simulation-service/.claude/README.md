# simulation-service - Local Context
...
cat ../../services/registry.json | jq '.services."simulation-service"'
...
# View impact report
cat services/impact-analysis.md | grep -A 10 "simulation-service"
```
...
pm2 logs simulation-service --lines 50 --nostream
```
...
pm2 logs simulation-service --lines 20
```
...
pm2 logs simulation-service --lines 50
```
...
### Service Won't Start
1. Check logs: `pm2 logs simulation-service`

...
> This is a critical service - impacts 7 other service(s).
...
cat ../../services/registry.json | jq '.services."auth-service"'
...
# View impact report
cat services/impact-analysis.md | grep -A 10 "auth-service"
```
...
pm2 logs auth-service --lines 50 --nostream
```
...
**Service Owner**: core
**Criticality**: critical
**Impact Radius**: 7 dependent service(s)

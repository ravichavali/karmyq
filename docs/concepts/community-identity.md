...
For the engineering details — the identity key, the idempotent create endpoint, the partial unique index, and the one-time de-duplication of historical data — see [ADR-062](/docs/concepts/adr-062-community-identity-idempotent-creation).
